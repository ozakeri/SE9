package com.example.sino.model.enumType;
...
public enum EntityNameEn {
    ...
    DriverProfile(9), DriverJob(10), Employee(11), LineCompany(12), LineCapacity(13), Violation(14), Licence(15), SeColor(16),
    ...
    ViolationBaseAction(30), ViolationSerial(31), SeProModel(32), AttachFile(33), AttachFileSetting(34), SystemParameter(35),
    HistoryLog(36), Committee(37), CommitteeSubject(38), Calender(39), Complaint(40), LineDailyReport(41), LineDailyReportDetail(42),
    EntityGrading(43), EntityGradingDetail(44), EntityGradingItem(45), CarOption(46), SubscribersService(47), LineTerminal(48),
    ...
    EntityDailyActivity(106), DailyEvent(107), Event(108), TimeLine(109), TimeLineDetail(110), EntityGradingGroup(111), Course(112), ProcessCourse(113),
    ...
    ProcessStrucSetting(194), ProcessStrucData(195), ContractInvoice(196), SubscribersComment(197), SubscribersRequest(198), SubscribersRequestCar(199),
    ...
    EventReport(206), FatalError(207), GapResourceBundle(208), PersonUrbanFleet(209), EtCardDriverLogin(210), EtCardDataTran(211), Accessory(212),
    EventInvoice(213), EventInvoiceItem(214), EtCardHalfPathInfo(215), SalaryAttributeParam(216), CarOptionDriverHealth(217), EntityBill(218),
    CarOptionFuelPrice (219), CarOptionCheckFuelValLic (220), ProcessIndexExecute(221), ProcessIndexUserPriority (222), ProcessIndexUserSetting(223), EntityInvoiceParam(224),
    CarInvoiceDriver(225), GapEntityStruc(226), GapEntityTreeCode(227), Country(228),
    SeProBrand(229), SeProBaseInfo(230), SeSupplier(231), SeKpiStruc(232), SeKpiStrucGrade(233), SeLicPer(234), SeLicPro(235),
    SeProSetting(236), SeCustomer(237), SeProService(238), SeProServicePlan(239), SeProModComp(240), SeProEntityRep1(241),
    PersonRelated(242), SePartStruc(243), SePartData(244), SePartPro(245);
