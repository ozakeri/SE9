...
public class FormListAdapter extends RecyclerView.Adapter<FormListAdapter.CustomView> {
    ...
    public void setOnItemClickListener(FormListAdapter.onIemClickListener clickListener) {
        FormListAdapter.clickListener = clickListener;
    }
